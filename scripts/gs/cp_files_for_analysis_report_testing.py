...
minio_cmd_1 = f'aws s3 sync s3://greensteam-data-prod/customer_data/ ~/data/greensteam-data-dev/{user}/customer_data/ --exclude="*" --include="*{vessel_slug}*"'
minio_cmd_2 = f'aws s3 sync s3://greensteam-data-prod/final/ ~/data/greensteam-data-dev/{user}/final/ --exclude="*" --include="*{vessel_slug}*"'
minio_cmd_3 = f'aws s3 sync s3://greensteam-prod/data-import/{customer_slug}/advanced/ ~/data/greensteam-dev/data-import/{customer_slug}/advanced/'
minio_cmd_4 = f'aws s3 sync s3://greensteam-data-prod/fouling_analysis/ ~/data/greensteam-data-dev/{user}/fouling_analysis/ --exclude="*" --include="*{vessel_slug}*"'
minio_cmd_5 = f'aws s3 sync s3://greensteam-data-prod/unification/ ~/data/greensteam-data-dev/{user}/unification/ --exclude="*" --include="*{vessel_slug}*"'
minio_cmd_6 = f'aws s3 sync s3://greensteam-models-prod/fouling_analysis/{vessel_slug}/ ~/data/greensteam-models-dev/antoni.szczepanik/fouling_analysis/{vessel_slug}/'
